...
pub const COMMANDS: &[Cmd] = &[
    ...
    Cmd { group: "Twin", name: "twin refresh", args: "<dir> [--prefix <p>] [--full]", summary: "observe a source tree, record only drift; --full reprocesses every file after extractor upgrades" },
    Cmd { group: "Twin", name: "twin status", args: "<dir> [--prefix <p>]", summary: "the same comparison, read-only" },
    ...
    Cmd { group: "Twin", name: "twin symbols", args: "<name>", summary: "what a file declares, with line numbers" },
    Cmd { group: "Twin", name: "twin imports", args: "<name> [--transitive]", summary: "what a file depends on; --transitive walks the closure" },
    Cmd { group: "Twin", name: "twin rdeps", args: "<name> [--transitive]", summary: "who depends on a file; --transitive is the blast radius" },
    Cmd { group: "Twin", name: "twin at", args: "<prefix> <ms|30m|2h|1d|git-hash>", summary: "the twin as it was: bi-temporal read at a moment or commit" },
    Cmd { group: "Twin", name: "twin search", args: "<substring>", summary: "find twinned entities by name" },
    Cmd { group: "Twin", name: "twin insights", args: "<prefix>", summary: "the synthesized picture: churn, hubs, tests, decisions, growth, last sleep" },
    Cmd { group: "Twin", name: "twin tests", args: "<prefix>", summary: "test files, frameworks, covers-relations, failing cases" },
    Cmd { group: "Twin", name: "twin stale", args: "<prefix>", summary: "docs invalidated by later changes to files they mention" },
    Cmd { group: "Twin", name: "ingest", args: "<dir> [--prefix <p>]", summary: "alias for twin refresh" },
    Cmd { group: "Twin", name: "note", args: "<name> <text...>", summary: "attach a durable note to any entity" },
    Cmd { group: "Twin", name: "notes", args: "<name>", summary: "read an entity's notes, in true order" },
    ...
    Cmd { group: "Documents", name: "plan add|list|show", args: "...", summary: "the same for plans (e.g. Claude Code plan files)" },
    ...
    Cmd { group: "Documents", name: "template set", args: "<slug> --applies-to k --capture <globs> [--fields spec] [--requires a,b]", summary: "teach the store a new artifact kind — capture rules as data, no code" },
    ...
    Cmd { group: "Automation", name: "hook install", args: "[dir] [--prefix p] [--docs] [--tests] [--test-cmd c]", summary: "every git commit/push refreshes the twin; --tests runs and imports the suite" },
