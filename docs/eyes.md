...
**Features** puts each claim beside its evidence, resolved to the present.
The definition of done counts linked records; Evidence checks what those
records currently say. When they disagree, you see both.
...
ADR-027 covers evidence you can look at. `design-draft/` remains a visual
and conceptual reference — a source of ideas, never an information
